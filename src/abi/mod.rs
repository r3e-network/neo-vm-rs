...
pub use stack_value::{
    ...
    STACK_VALUE_CODEC_TAG_POINTER, STACK_VALUE_CODEC_TAG_STRUCT, StackItemType, StackValue,
    byte_sequence_bytes, byte_sequence_len, concat_splice_values, decode_integer_bytes,
    default_value_for_type_tag, encode_integer, is_defined_neovm_type_tag,
    new_array_default_value_for_neovm_type_tag,
    new_array_default_value_for_type_tag, normalize_stack_item_type_tag, pop_byte_arg,
    slice_splice_value, stack_value_as_bigint, stack_value_as_bool, stack_value_as_bytes,
    stack_value_as_fixed_bytes, stack_value_as_i64, stack_value_as_string, stack_value_as_u8,
    stack_value_as_u32, stack_value_into_items, stack_value_span_bytes,
};
